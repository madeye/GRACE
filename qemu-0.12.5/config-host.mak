...
# Configured with: './configure' '--prefix=/root/qemu' '--target-list=x86_64-softmmu' '--disable-user' '--disable-kvm' '--disable-vnc-tls' '--disable-bluez' '--disable-vnc-sasl' '--enable-io-thread'
...
HELPER_CFLAGS=
LDFLAGS=-Wl,--warn-common -m64 -g  -ldl
